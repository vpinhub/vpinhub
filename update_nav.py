...
NEW_NAV = """    <nav class="glass border-b border-white/10 p-4 md:p-6 sticky top-0 z-50">
        <div class="container mx-auto flex flex-wrap items-center justify-between gap-4">
            ...
            <div class="hidden xl:flex items-center gap-6 text-[10px] md:text-xs font-bold uppercase tracking-widest">
                ...
                <a href="https://vpinhub.github.io/competitioncentral/index.html" class="text-orange-400 hover:text-orange-300 transition-colors">Competition</a>
                ...
                <span class="text-white/20">|</span>
                <a href="https://vpinhub.github.io/competitioncentral/showcase.html" class="text-gray-300 hover:text-cyan-400 transition-colors">Latest Tables</a>
        ...
        <div id="mobile-menu" class="xl:hidden flex flex-col gap-4 mt-4 pt-4 border-t border-white/10 text-xs font-bold uppercase tracking-widest px-2 pb-2">
            ...
            <a href="https://vpinhub.github.io/competitioncentral/index.html" class="text-orange-400 hover:text-orange-300">Competition</a>
            ...
            <a href="https://vpinhub.github.io/competitioncentral/showcase.html" class="text-cyan-400 hover:text-cyan-300">Latest Tables</a>
